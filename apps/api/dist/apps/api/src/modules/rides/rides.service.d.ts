...
export declare class RidesService {
    ...
    autoArchiveOldRides(): Promise<void>;
    cleanupStaleDrafts(): Promise<void>;
    sendDepartureReminders(): Promise<void>;
    abort(rideId: string, userId: string, reason: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: import(".prisma/client").$Enums.RideStatus;
    ...
    getGivenRides(userId: string, status?: string, includeHistory?: boolean): Promise<({
        vehicle: {
            year: number | null;
            id: string;
            isActive: boolean;
