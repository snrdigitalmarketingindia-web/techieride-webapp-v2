...
let RidesController = class RidesController {
    ...
    getGiven(userId, status, history) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], RidesController.prototype, "community", null);
__decorate([
    (0, common_1.Get)('given'),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
    __param(1, (0, common_1.Query)('status')),
    __param(2, (0, common_1.Query)('history')),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, String, String]),
    __metadata("design:returntype", void 0)
], RidesController.prototype, "abort", null);
__decorate([
